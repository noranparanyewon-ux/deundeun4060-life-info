...
export default function SearchPage() {
  ...
  return (
    <>
      ...
      <div className="container breadcrumb"><Link href="/">홈</Link><span>/</span><span>정보 검색</span></div>
